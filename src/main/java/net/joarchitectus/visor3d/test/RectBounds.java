...
class RectBounds {
    ...
    /**
     * Creates an instance with initially invalid bounds ready to be used with
     * {@link #addPoint(double, double, double)}.
     */
    RectBounds() {
     ...
     * <p>
     * If the point is already in the interior of the bounded area the bounds
     * are not changed.</p>
     *
    ...
    /**
     * Gets the scale factor by which the box needs to be multiplied that it
     * fits into a cube with edge length 1.
     */
